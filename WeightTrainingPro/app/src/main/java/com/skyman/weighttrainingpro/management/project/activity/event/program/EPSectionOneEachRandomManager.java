...
import com.skyman.weighttrainingpro.management.event.program.util.RandomEventSelectionUtil;
...
public class EPSectionOneEachRandomManager extends EPSectionManager implements SectionInitialization {
    ...
    // constant
    private static final String CLASS_NAME = "[PAEP]_EPSectionOneRandomManager";       // EventProgramActivity Section One Each Random Manager
    ...
    // constructor
    public EPSectionOneEachRandomManager(Activity activity, User user, MuscleArea muscleArea, GroupingEventData groupingEventData) {
