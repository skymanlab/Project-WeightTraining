...
public class EPSectionOneAllRandomManager extends EPSectionManager implements SectionInitialization {
    ...
    // constructor
    public EPSectionOneAllRandomManager(Activity activity, User user, MuscleArea muscleArea, ArrayList<Event> eventArrayList, GroupingEventData groupingEventData) {
