package com.skyman.weighttrainingpro.management.project.activity.event.program.process;
...
public class EPSPSectionManager extends SectionManager implements SectionInitialization {
    ...
    // constructor
    public EPSPSectionManager(Activity activity, User user, Event event, int setNumber, int restTime, FragmentManager fragmentManager) {
        super(activity, user);
        this.event = event;
