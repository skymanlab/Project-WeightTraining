...
public class SessionManager {
    ...
    /**
     * [method] intent 에 googleIdToken 으로 추가한다.
     */
    public static void setGoogleIdTokenInIntent(Intent intent, String googleIdToken) {

        // [lv/C]Intent : content 를 'googleIdToken' 로 넣기
    ...
    /**
     * [method] intent 에 추가되어 넘어온 데이터 중 googleIdToken 로 값 가져오기
     */
    public static String getGoogleIdTokenInIntent(Intent intent) {

        return intent.getStringExtra("googleIdToken");
