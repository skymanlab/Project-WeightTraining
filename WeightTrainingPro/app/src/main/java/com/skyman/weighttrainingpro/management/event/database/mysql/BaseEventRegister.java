...
public class BaseEventRegister extends AsyncTask<Event, Void, Event> {

    // constant
    private static final String CLASS_NAME = "[EDM]_BaseEventRegister";
    ...
    // constructor
    public BaseEventRegister(Activity activity, int mattersOfProgress, EventDbManager eventDbManager) {
        this.activity = activity;
        this.mattersOfProgress = mattersOfProgress;
...
//        LogManager.displayLogOfEvent(CLASS_LOG_DISPLAY_POWER, CLASS_NAME, METHOD_NAME, event);
        ...
        if (RightDataChecker.checkWhetherRightEvent(event)) {
            ...
            // [check 2] : event table 메니저가 생성되었습니다.
...
//                LogManager.displayLog(CLASS_LOG_DISPLAY_POWER, CLASS_NAME, METHOD_NAME, "-=================> 저장 완료");
                ...
                LogManager.displayLog(CLASS_LOG_DISPLAY_POWER, CLASS_NAME, METHOD_NAME, "1. mattersOfProgress = " + mattersOfProgress);
