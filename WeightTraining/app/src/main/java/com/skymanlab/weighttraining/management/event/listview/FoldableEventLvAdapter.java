...
public class FoldableEventLvAdapter extends BaseAdapter {
    ...
    // constructor
    public FoldableEventLvAdapter(Activity targetActivity, FragmentManager fragmentManager, String uid) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = inflater.inflate(R.layout.custom_list_foldable_event_item, parent, false);
        }

        // widget mapping
        TextView count = (TextView) convertView.findViewById(R.id.custom_list_foldable_event_item_count);
        TextView eventName = (TextView) convertView.findViewById(R.id.custom_list_foldable_event_item_event_name);
        ImageView expandSelector = (ImageView) convertView.findViewById(R.id.custom_list_foldable_event_item_expand_selector);

        LinearLayout contentWrapper = (LinearLayout) convertView.findViewById(R.id.custom_list_foldable_event_item_content_wrapper);
        TextView equipmentType = (TextView) convertView.findViewById(R.id.custom_list_foldable_event_item_equipment_type);
        TextView groupType = (TextView) convertView.findViewById(R.id.custom_list_foldable_event_item_group_type);
        TextView properWeight = (TextView) convertView.findViewById(R.id.custom_list_foldable_event_item_proper_weight);
        TextView maxWeight = (TextView) convertView.findViewById(R.id.custom_list_foldable_event_item_max_weight);

        TextView modify = (TextView) convertView.findViewById(R.id.custom_list_foldable_event_item_modify);
        TextView delete = (TextView) convertView.findViewById(R.id.custom_list_foldable_event_item_delete);

        // [lv/C]Event : 하나의 리스트에 표시할 데이터
        Event event = (Event) getItem(position);

        // [check 1] : 해당 position 의 item 이 그려질 때, isFolded 을 확인하여 view 를 재설정
...
//        LogManager.displayLogOfEvent(CLASS_LOG_DISPLAY_POWER, CLASS_NAME, METHOD_NAME, event);
    ...
    private void setClickListenerOfModify(TextView modify, final int position) {
        ...
        final FoldableEventLvAdapter adapter = this;
