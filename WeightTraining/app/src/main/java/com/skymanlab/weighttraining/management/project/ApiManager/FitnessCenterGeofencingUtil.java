...
public class FitnessCenterGeofencingUtil {
    ...
    private static final int PENDING_INTENT_REQUEST_CODE_FITNESS_CENTER_GEOFENCING = 60000;
    ...
    public static Geofence createGeofence(LatLng location, float radiusInMeters, long expirationInMilliseconds, int transitionType, int loiteringDelay) {
    ...
    public static PendingIntent createPendingIntent(Context context) {
        ...
        return PendingIntent.getBroadcast(
                context,
                PENDING_INTENT_REQUEST_CODE_FITNESS_CENTER_GEOFENCING,
                intent,
