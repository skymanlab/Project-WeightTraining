...
import com.skymanlab.weighttraining.management.event.program.util.DirectEventSelectionUtil;
...
public class EPSectionOneDirectManager extends EPSectionManager implements SectionInitialization {
    ...
    // constant
    private static final String CLASS_NAME = "[PAEP] EPSectionOneDirectManager";       // EventProgramActivity Section One Each Random Manager
    ...
    // constructor
    public EPSectionOneDirectManager(Activity activity, FirebaseUser firebaseUser, MuscleArea muscleArea, GroupingEventData groupingEventData) {
