...
//                                    progressBar.setVisibility(View.INVISIBLE);
                                ...
                                if (myFitnessCenter != null) {
                                    ...
                                    LogManager.displayLog(CLASS_LOG_DISPLAY_POWER, CLASS_NAME, METHOD_NAME, "===============");
                                    myFitnessCenter.setAttendanceDateList(attendanceDateList);
                                    ...
                                    LogManager.displayLog(CLASS_LOG_DISPLAY_POWER, CLASS_NAME, METHOD_NAME, "< UserFitnessCenter >  = " + myFitnessCenter.getMemberNumber());
                                ...
                                listener.onRegisterMyFitnessCenter(myTraining, myFitnessCenter);
                            }
    ...
    public interface OnFitnessCenterEventListener {
        void onRegisterMyFitnessCenter(UserTraining userTraining, UserFitnessCenter userFitnessCenter);
