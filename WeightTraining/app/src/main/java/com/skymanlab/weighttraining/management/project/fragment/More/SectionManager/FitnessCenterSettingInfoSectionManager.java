...
public class FitnessCenterSettingInfoSectionManager extends FragmentSectionManager implements FragmentSectionInitializable {
    ...
    // constructor
    public FitnessCenterSettingInfoSectionManager(Fragment fragment, View view) {
        super(fragment, view);
    }
    ...
    public void connectWidget() {
        ...
        this.isAllowedAccessNotification = (Switch) getView().findViewById(R.id.f_fitnessCenterSettingInfo_isAllowedAccessNotification);

        // [ MaterialCardView | backgroundLocationPermissionGrantedGo ]
        this.backgroundLocationPermissionGrantedGo = (MaterialCardView) getView().findViewById(R.id.f_fitnessCenterSettingInfo_isAllowedAccessNotification_grantedGo);

        // [ Switch | isDisclosed ]
        this.isDisclosed = (Switch) getView().findViewById(R.id.f_fitnessCenterSettingInfo_isDisclosed);
    ...
    private void initWidgetOfIsAllowedAccessNotification() {
        ...
        // FitnessCenter 접근알림을 위한 지오팬싱 등록하기
