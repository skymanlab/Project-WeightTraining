...
public class EventItemFoldableLvAdapter extends BaseAdapter {
    ...
    // constructor
    public EventItemFoldableLvAdapter(Activity targetActivity, FragmentManager fragmentManager, String uid) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        ImageView expandSelector = (ImageView) convertView.findViewById(R.id.cu_event_item_expand_selector);
...
//        LogManager.displayLogOfEvent(CLASS_LOG_DISPLAY_POWER, CLASS_NAME, METHOD_NAME, event);
    ...
    private void setClickListenerOfModify(TextView modify, final int position) {
        ...
        final EventItemFoldableLvAdapter adapter = this;
