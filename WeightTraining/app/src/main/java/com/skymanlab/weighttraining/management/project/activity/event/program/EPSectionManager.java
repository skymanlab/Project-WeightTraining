...
import com.skymanlab.weighttraining.EventProgramListActivity;
...
public abstract class EPSectionManager extends SectionManager {
    ...
    // constructor
    public EPSectionManager(Activity activity, FirebaseUser firebaseUser, MuscleArea muscleArea) {
    ...
    public void moveEventSelectionProgramActivity(ArrayList<Event> selectedEventArrayList, ArrayList<Event> noSelectedEventArrayList) {
        ...
        // [lv/C]SessionManager : intent 에 muscleArea, 무작위로 선택된 eventArrayList , 나머지 선택되지 않은 eventArrayList 를 추가한다.
