...
import com.skymanlab.weighttraining.management.event.listview.EventItemLvAdapter;
...
//
//    // constructor
//    public EventModificationDialog(Context context, String uid,  ArrayList<Event> eventArrayList, int position) {
