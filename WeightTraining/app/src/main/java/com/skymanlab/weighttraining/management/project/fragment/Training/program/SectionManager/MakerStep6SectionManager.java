...
import com.skymanlab.weighttraining.management.project.fragment.Training.program.item.Step6EventItem;
import com.skymanlab.weighttraining.management.project.fragment.Training.program.item.Step6FinalOrderItem;
...
public class MakerStep6SectionManager extends FragmentSectionManager implements FragmentSectionInitializable, MakerStepManager.OnPreviousClickListener, MakerStepManager.OnNextClickListener {
    ...
    private HashMap<String, Step6FinalOrderItem> finalOrderItemList;

    // instance variable : [2] event
    private HashMap<String, Step6EventItem> eventItemList;
    ...
    public void initWidget() {
        ...
        this.eventItemList = new HashMap<String, Step6EventItem>();

        // [iv/C]HashMap<String, Step4FinalOrderItem> :
        this.finalOrderItemList = new HashMap<String, Step6FinalOrderItem>();
    ...
    private void initItemByMuscleArea(LayoutInflater inflater, ArrayList<Event> eventArrayList ) {
        ...
        if (!eventArrayList.isEmpty()) {
            ...
            for (int index=0; index < eventArrayList.size() ; index++ ) {
                ...
                Step6EventItem eventItem = createEventItem(inflater, eventArrayList.get(index), (index + 1));
                ...
                Step6FinalOrderItem finalOrderItem = createFinalOrderItem(inflater, eventArrayList.get(index), (index + 1));
     ...
     */
    private void addItemToEventItemList(String eventKey, Step6EventItem eventItem) {
     ...
     */
    private void addItemToFinalOrderItemList(String eventKey, Step6FinalOrderItem finalOrderItem) {
     ...
     */
    private Step6EventItem createEventItem(LayoutInflater inflater, Event event, int eventNumber) {
        final String METHOD_NAME = "[createEventItem] ";

        // [lv/C]Step4EventItem : event item 의 초기 내용을 설정한다.
        Step6EventItem eventItem = new Step6EventItem.Builder()
                ...
                .setItemClickListener(new Step6EventItem.OnItemClickListener() {
                    @Override
    ...
    private Step6FinalOrderItem createFinalOrderItem(LayoutInflater inflater, Event event, int eventNumber) {
        final String METHOD_NAME = "[Step4FinalOrderItem] ";

        // [lv/C]Step4FinalOrderItem : final order item 의 초기 내용을 설정한다.
        Step6FinalOrderItem finalOrderItem = new Step6FinalOrderItem.Builder()
                .setInflater(inflater)
                .setContentWrapperColor(ContextCompat.getColor(getActivity(), DataManager.convertColorIntOfMuscleArea(event.getMuscleArea())))
                .setEvent(event)
                .setEventNumber(eventNumber)
                .setItemClickListener(new Step6FinalOrderItem.OnItemClickListener() {
                    @Override
     ...
     * @param eventItem
     */
    private void addViewToEventListWrapper(Step6EventItem eventItem) {
