...
public class Step4FinalOrderItem {
    ...
    // constructor
    private Step4FinalOrderItem(Builder builder) {
    ...
    private View inflateItem() {
        ...
        return inflater.inflate(R.layout.include_step4_final_order_item, null);
    ...
    public static class Builder {
        ...
        public Step4FinalOrderItem init() {
            return new Step4FinalOrderItem(this);
        }
    }
}
