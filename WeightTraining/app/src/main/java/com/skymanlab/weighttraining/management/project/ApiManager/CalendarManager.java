...
public class CalendarManager {
    ...
    // constant
    private static final String CLASS_NAME = CalendarManager.class.getSimpleName();
    ...
    public class AttendanceDateDecorator implements DayViewDecorator {
        ...
        @Override
        public void decorate(DayViewFacade view) {
            view.addSpan(new DotSpan(13, ContextCompat.getColor(context, R.color.colorBackgroundGreen)));
        }
    }
